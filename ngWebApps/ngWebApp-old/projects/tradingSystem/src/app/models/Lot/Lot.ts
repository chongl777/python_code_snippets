...
export class Lot extends SecurityDataObject implements SerializableAsync<Lot> {
    ...
    get price(): number {
        return this.security.marketData.priceData.compositePrice || 0;
    }
    ...
    get marketVal_clean(): number {
        ...
        return this.marketData.factor * this.multiplier * this.quantity *
            this.security.marketData.priceData.compositePrice * this.fx;
    }

    get exposure(): number {
        return this.marketData.factor * this.multiplier * this.quantity *
            this.marketData.priceData.compositePrice * this.fx +
            this.accrued;
    }
