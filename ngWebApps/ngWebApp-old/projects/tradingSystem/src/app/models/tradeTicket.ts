...
function convertToDate(val: string): Date {
...
export class TradeTicket implements Serializable<TradeTicket> {
    dirty: boolean = false;
    ...
    deserialize(json: any): TradeTicket {
    ...
    deserialize_confirmed(json: any): TradeTicket {
