...
import { Observable, of, Subject, BehaviorSubject, Subscription, merge } from 'rxjs';
import { finalize, delay, take, timeout, switchMap, debounceTime } from 'rxjs/operators';
        ...
        let sub$ = this.msgController.portfolioLoad$
            ...
            .subscribe({
                ...
                complete: async () => {
                    ...
                    this.loading$.next(false);
                    this.update();
                    console.log('load all positions done!');
                }
            });
    }
