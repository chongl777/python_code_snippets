...
export class PortfolioLookthroughComponent extends _Component implements OnInit, AfterViewInit {
    ...
    @Input() public columnsToDisplay = [
        ...
        'Factor', 'ModifiedDur', 'YTM', 'YTW', 'YTF', 'MarketVal', 'Exposure', 'Change', 'Pnl',
        'EqRet', 'Rtg', 'MarketSeg', 'LiqScore', 'EMC', 'RVS', 'ERH', 'FA', 'LR',
        'LR_S', 'LR_S_SW'];
    ...
    public availableGroupOptions = [
        ...
        'deal', 'marketSegment', 'sec_description'];
    ...
    OpenSettingDialog() {
        this.subscription.add(DialogWindowComponent.OpenSetting(
