...
import { BookingRxStompService, EventRxStompService, FixRxStompService } from '@app/configs/msg-queue.service.config';
...
export class MsgControllerService {
    ...
    get marketDataLoad$(): Subject<any> {
        return this.msgClient.stream('/mkt_data', 10 * 60 * 1000);
    };
    ...
    get portfolioLoad$(): Subject<any> {
        return this.msgClient.stream('/portfolio_allocation', 2 * 60 * 1000);
    };
    ...
    private eventMsgClient: MsgClient;
    ...
    constructor(
        ...
        this.eventMsgClient = new MsgClient(this.eventRxStompService);
        ...
        this.subscription.add(this.eventConnectionState$.subscribe(
            (state: RxStompState) => {
        ...
        // event
        this._eventSessionId = sessionStorage.tabID ? sessionStorage.tabID : sessionStorage.tabID = uuid();
        this.securitySelect$ = this.eventMsgClient.topic_subscription(
            this._eventSessionId, 'security_selected',
        );
