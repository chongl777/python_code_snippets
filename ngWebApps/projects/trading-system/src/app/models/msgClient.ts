...
export class MsgClient {
    ...
    constructor(
        ...
        this.msg_queue = msg_queue_config.msg_queue;
        this.time_out = msg_queue_config.time_out;
    }
    ...
    stream_timeout(route: string, time_out: number, ...args: any[]): any {
        console.log('start stream pipe ' + route)
    ...
    stream(route: string, time_out: number = null, ...args: any[]): any {
        return this.stream_timeout(route, time_out || this.time_out, ...args);
    }
