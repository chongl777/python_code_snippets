...
export class IoiStatusComponent implements AfterViewInit, OnDestroy {
    ...
    openTradeDialog() {
        ...
        const modalDialog = DialogWindowComponent.OpenTradeDialog(
            this.matDialog, IoiOrderComponent, this.ioi.order);
