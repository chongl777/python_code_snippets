...
export type DeviceType = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'xxl' | 'all';
...
export class Transfrom implements TransformInterface {
    constructor(public xs = 0, public sm = 0, public md = 0, public lg = 0,
        public xl?, public xxl?, public all = 0) { }
}
...
export class Breakpoints implements BreakpointsInterface {
    constructor(
        public xs = 500, public sm = 768, public md = 992,
        public lg = 1200, public xl = 1600, public xxl = 2000) { }
}
