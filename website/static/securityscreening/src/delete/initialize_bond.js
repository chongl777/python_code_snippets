            ...
            {datasource: 'security_screening',
             ...
             process_row: function(row, rowdata) {
                 ...
                 $('.sid-clickable', row).click(function() {
                     var url = 'http://wfiubuntu01/pfmgmt/sec_profile/security_profile?sid={sid}&pid={pid}'
                     url = url.replace(
             ...
             columns_setup: [
                 ...
                 {data: 'max_dd',
                  sortable: false,
                  visible: true,
                  title: '<div class="hover" data="max_dd">Max Draw Down</div>',
                  width: '5%',
                  render: function(value, type, row) {
