...
var paramsInput = new (function () {
    ...
    this.title = ko.pureComputed(function() {
        return "Bond Being Monitored (As Of " + self.t_date().slice(0, 10) + ")";
    });
...
function initialize(PARAMS) {
    PARAMS['widget']['security-screening-0'] = addTitle(
     ...
     PARAMS['widget']['security-screening-1'] = addTitle(
        create_monitored_table(
            ...
            title='ENTRY PRICE REACHED (CURRENTLY NO POSITIONS)',
    ...
    PARAMS['widget']['security-screening-2'] = addTitle(
        create_monitored_table(
            ...
            title='TAEGET PRICE REACHED (CURRENTLY HOLD POSITIONS)',
    ...
    PARAMS['widget']['security-screening-3'] = addTitle(
        create_monitored_table(
            ...
            title='WORST PRICE REACHED (CURRENTLY HOLD POSITIONS)',
