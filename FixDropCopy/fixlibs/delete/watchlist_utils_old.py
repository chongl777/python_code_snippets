...
"""
    try:
        ...
        wl_details = f"""
          ...
          <tr class="odd">
              <td>&nbsp;Our Position: Security (MM)</td>
              <td>&nbsp; {info['watch_list']['current_qty']/1e6: ,.3f}</td>
          </tr>
          <tr class="even">
              <td>&nbsp;Our Position: Deal (MM)</td>
              <td>&nbsp; {info['watch_list']['current_qty_issuer_level']/1e6: ,.3f}</td>
          </tr>
          <tr class="odd">
              <td>&nbsp;Max to Trade (MM)</td>
              <td>&nbsp; {info['watch_list']['max_qty_2_trd']/1e6: ,.3f}</td>
          </tr>
          <tr class="even">
              <td colspan="2">&nbsp;</td>
          </tr>
