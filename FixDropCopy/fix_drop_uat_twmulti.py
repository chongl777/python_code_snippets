...
def main():
    ...
    with DropFIX(
        ...
        try:
            ...
            logger2 = getLogger('ioi_con', log_format)
            logger2.setLevel(log_level)
            logger2.addHandler(email_logging_handler)
